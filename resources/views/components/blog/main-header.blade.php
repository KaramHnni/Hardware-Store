<header class=" px-8 fixed w-full flex border-t-4 border-solid border-yellow justify-between items-center">
    @include('components.blog.logo')
        ...
        <ul class="list-reset flex  items-center">
            ...
            @endguest
            @auth
            <li class="relative profile--dropdown--trigger py-4 "><a href="#" class="main-header__item inline-block mx-2 px-2 py-2  text-white">{{auth()->user()->username}}</a>
