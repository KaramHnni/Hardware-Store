        ...
        <ul class="list-reset flex  items-center">
            ...
            <li class="relative profile--dropdown--trigger"><a href="#" class="main-header__item inline-block mx-2 px-2 py-2  text-white">{{auth()->user()->username}}</a>
                <ul class="profile--dropdown--menu py-4 absolute w-full bg-white text-black shadow list-reset text-center">
                    <li class="text-center"><a href="#" class="main-header__item inline-block mx-2 my-4 px-2 py-2  text-black">Create New Post</a></li>
                    <li class="text-center"><a href="#" class="main-header__item inline-block mx-2 my-4 px-2 py-2  text-black">Create New Channel</a></li>
